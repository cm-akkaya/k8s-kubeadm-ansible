...
#
# Kullanım:
#   chmod +x scripts/generate-and-distribute-deploy-key-isimi-vererek.sh
#   ./scripts/generate-and-distribute-deploy-key-isimi-vererek.sh
#   BOOTSTRAP_KEY_OVERRIDE=~/.ssh/ozel-key ./scripts/generate-and-distribute-deploy-key-isimi-vererek.sh
#   BOOTSTRAP_KEY_OVERRIDE=~/.ssh/platform-k8s-ed25519-ssh-key-kubespray ./scripts/generate-and-distribute-deploy-key-isimi-vererek.sh
